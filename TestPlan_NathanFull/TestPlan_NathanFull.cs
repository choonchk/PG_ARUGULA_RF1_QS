...
{
    public class NathanFull : TestPlanBase, IATFTest
    {
        ...
        public override string DoATFInit(string args)
        {
            ...
            else
            {
                ...
                if (m_modelTpState.Pa_Site)
                {
                    m_modelTpState.SetTesterSite(new Tester.PgNathanRf1Tester());
                }
            }
        ...
        private bool InitializePaTest(PaEquipmentInitializer eqInitModel)
        {
            ...
            bool isSuccess = ccm.CableCalibration(m_doClotho1.ClothoRootDir, "NATHAN", isMagicBox);
            ...
            if (!m_modelTpState.Spara_Site)
            {
                ...
                {      
                    ...
                    load_board_id = load_board_id.Contains("824X") ? load_board_id : "LB-824X-XXX-NAN";
                    ...
                    contactor_id = contactor_id.Contains("824X") ? contactor_id : "LN-824X-XXX-NAN";
        ...
        private void BuildResult(bool isDebugMode)
        {
            ...
            if (!isDebugMode)
            {
                ...
                if (!m_modelTpState.Spara_Site) m_modelTestRunner.CheckData_BurnOTP_PassFlag(isGUCALSuccess);
               return;
            }
