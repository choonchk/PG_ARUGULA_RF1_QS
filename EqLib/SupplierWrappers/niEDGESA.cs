...
namespace NationalInstruments.RFToolkits.Interop
{
    public class niEDGESA
    {
        ...
        {
            int pInvokeResult = PInvoke.niEDGESA_RFSAAutoLevel(rfsaHandle, bandwidth, measurementInterval, maxNumberofIterations, out resultantReferenceLevel);
        ...
        #region v1.1 Methods
        /// <summary>
        /// Enables the measurements that you specify in the measurements parameter and disables all other measurements. If you set the enableTraces parameter to NIEDGESA_VAL_TRUE, it will enable all the traces for the measurements that you select.
        /// 
        /// </summary>
        ///<param name = "measurements">
        /// Specifies the measurements that you want to enable.
        /// NIEDGESA_VAL_EVM_MEASUREMENT (0x00000001)
        /// Enables error vector magnitude (EVM) measurements.
        /// NIEDGESA_VAL_ORFS_MEASUREMENT (0x00000002)
        /// Enables output radio frequency spectrum (ORFS) measurements.
        /// NIEDGESA_VAL_PVT_MEASUREMENT (0x00000004)
        /// Enables power versus time (PvT) measurements.
        /// 
        ///</param>
        ///<param name = "enableTraces">
        /// Enables all the traces for the selected measurement. The default value is NIEDGESA_VAL_FALSE.
        /// 
        ///</param>
        ///<returns>
        /// 
        ///niEDGESA_SelectMeasurementsWithTraces
        /// int32 __stdcall niEDGESA_SelectMeasurementsWithTraces (niEDGESASession session, 
        ///     uInt32 measurements,
        ///     int32 enableTraces);
        /// Purpose
        /// Enables the measurements that you specify in the measurements parameter and disables all other measurements. If you set the enableTraces parameter to NIEDGESA_VAL_TRUE, it will enable all the traces for the measurements that you select.
        /// 
        ///</returns>
        public int SelectMeasurementsWithTraces(UInt32 measurements, bool enableTraces)
        {
            int pInvokeResult = PInvoke.niEDGESA_SelectMeasurementsWithTraces(Handle, measurements, Convert.ToInt32(enableTraces));
            TestForError(pInvokeResult);
            return pInvokeResult;
        }

        /// <summary>
        /// <p class="Body">Returns the burst power trace averaged across timeslots.
        /// 
        /// </summary>
        ///<param name = "t0">
        /// Returns the initial time of the plot, in seconds.
        ...
        /// 
        ///</param>
        ///<param name = "averagePower">
        /// Returns the burst power trace averaged across timeslots. You can pass NULL to the averagePower parameter to get size of the array in the actualNumDataArrayElements parameter.
        /// 
        ///</param>
        ///<param name = "dataArraySize">
        /// Specifies the number of elements in the averagePower array. You can pass 0 to the dataArraySize parameter to get the size of the array in the actualNumDataArrayElements parameter.
        /// 
        ///</param>
        ///<param name = "actualNumDataArrayElements">
        /// Returns the actual number of elements populated in the averagePower parameter. If the array is not large enough to hold all the samples, the function returns an error and the actualNumDataArrayElements parameter returns the minimum expected size of the output array.
        /// 
        ///</param>
        ///<returns>
        /// 
        ///niEDGESA_TxPGetAveragePowerTrace
        /// int32 __stdcall niEDGESA_TxPGetAveragePowerTrace (niEDGESASession session,
        ///     float64 *t0,
        ///     float64 *dt,
        ...
        /// 
        ///</returns>
        public int TxPGetAveragePowerTrace(out double t0, out double dt, double[] averagePower, int dataArraySize, out int actualNumDataArrayElements)
        {
            int pInvokeResult = PInvoke.niEDGESA_TxPGetAveragePowerTrace(Handle, out t0, out dt, averagePower, dataArraySize, out actualNumDataArrayElements);
            TestForError(pInvokeResult);
            return pInvokeResult;
        }
        /// <summary>
        /// <p class="Body">Returns the unprocessed I/Q signal acquired from the RF signal analyzer.
        /// 
        /// </summary>
        ///<param name = "t0">
        /// Returns the initial time of the plot, in seconds.
        ...
        /// 
        ///</param>
        ///<param name = "acquiredIQWaveform">
        /// Returns the unprocessed I/Q signal acquired from RF Signal Analyzer. You can pass NULL to the acquiredIQWaveform parameter to get size of the array in the actualNumDataArrayElements parameter.
        /// 
        ///</param>
        ///<param name = "dataArraySize">
        /// Specifies the number of elements in the acquiredIQWaveform array. You can pass 0 to the dataArraySize parameter to get the size of the array in the actualNumDataArrayElements parameter.
        /// 
        ///</param>
        ///<param name = "actualNumDataArrayElements">
        /// Returns the actual number of elements populated in the acquiredIQWaveform parameter. If the array is not large enough to hold all the samples, the function returns an error and the actualNumDataArrayElements parameter returns the minimum expected size of the output array.
        ...
        ///<returns>
        /// 
        ///niEDGESA_TxPGetCurrentIterationAcquiredIQWaveformTrace
        /// int32 __stdcall niEDGESA_TxPGetCurrentIterationAcquiredIQWaveformTrace (niEDGESASession session, 
        ///     float64 *t0, 
        ///     float64 *dt,
        ///     niComplexNumber acquiredIQWaveform[],
        ///     int32 dataArraySize,
        ///     int32 *actualNumDataArrayElements);
        /// Purpose
        /// <p class="Body">Returns the unprocessed I/Q signal acquired from the RF signal analyzer.
        /// 
        ///</returns>
        public int TxPGetCurrentIterationAcquiredIQWaveformTrace(out double t0, out double dt, niComplexNumber acquiredIQWaveform, int dataArraySize, out int actualNumDataArrayElements)
        {
            int pInvokeResult = PInvoke.niEDGESA_TxPGetCurrentIterationAcquiredIQWaveformTrace(Handle, out t0, out dt, acquiredIQWaveform, dataArraySize, out actualNumDataArrayElements);
            TestForError(pInvokeResult);
            return pInvokeResult;
        }

        /// <summary>
        /// Configures the RF signal analyzer and initiates acquisition on the RF signal analyzer. This function then fetches the waveforms and calls the niEDGESA_AnalyzeIQComplexF64 function in a loop n times to perform measurements on the acquired waveforms, where n is equal to the number of averages specified.
        /// 
        /// </summary>
        ///<param name = "rFSAHandle">
        /// Identifies the instrument session. The toolkit obtains this value from the niRFSA_init function or the niRFSA_InitWithOptions function.
        /// 
        ///</param>
        ///<param name = "timeout">
        /// Specifies the time allotted, in seconds. The function passes this value to the timeout parameter of the niRFSA Fetch IQ function. The default value is 10. 
        /// 
        ///</param>
        ///<returns>
        /// 
        ///niEDGESA_RFSAMeasure
        /// int32 __stdcall niEDGESA_RFSAMeasure (niEDGESASession session,
        ...
        {
            int pInvokeResult = PInvoke.niEDGESA_RFSAMeasure(Handle, rFSAHandle, timeout);
            TestForError(pInvokeResult);
            return pInvokeResult;
        }

        /// <summary>
        ///Specifies the method that the toolkit uses to synchronize to the start of the burst.
        ///    The default value is NIEDGESA_VAL_BURST_SYNCHRONIZATION_METHOD_TSC.   
        /// 
        /// </summary>
        public int SetBurstSynchronizationMethod(string channel, int value)
        {
            return SetInt32(niEDGESAProperties.BurstSynchronizationMethod, channel, value);
        }
        /// <summary>
        ///Specifies the method that the toolkit uses to synchronize to the start of the burst.
        ///    The default value is NIEDGESA_VAL_BURST_SYNCHRONIZATION_METHOD_TSC.   
        /// 
        /// </summary>
        public int GetBurstSynchronizationMethod(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.BurstSynchronizationMethod, channel, out value);
        }

        /// <summary>
        ///Specifies the type of the modulation that the toolkit uses to analyze the signal that the device transmits.
        ///    The default value is NIEDGESA_VAL_MODULATION_TYPE_8PSK.
        ///    Set Function: niEDGESA_SetModulationType
        ///    Get Function: niEDGESA_GetModulationType
        /// 
        /// </summary>
        public int SetModulationType(string channel, int value)
        {
            return SetInt32(niEDGESAProperties.ModulationType, channel, value);
        }
        /// <summary>
        ///Specifies the type of the modulation that the toolkit uses to analyze the signal that the device transmits.
        ///    The default value is NIEDGESA_VAL_MODULATION_TYPE_8PSK.
        ...
        /// 
        /// </summary>
        public int GetModulationType(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.ModulationType, channel, out value);
        }

        /// <summary>
        ///Specifies the width of the filter as defined in section 3.5 of the 3GPP TS 45.004 v9.0.0 specifications.
        ///    Refer to the Burst Types topic for more information about the types of bursts.
        ///    The default value is NIEDGESA_VAL_FILTER_WIDTH_NARROW.
        ///    Set Function: niEDGESA_SetFilterWidth
        ///    Get Function: niEDGESA_GetFilterWidth
        /// 
        /// </summary>
        public int SetFilterWidth(string channel, int value)
        {
            return SetInt32(niEDGESAProperties.FilterWidth, channel, value);
        }
        /// <summary>
        ///Specifies the width of the filter as defined in section 3.5 of the 3GPP TS 45.004 v9.0.0 specifications.
        ///    Refer to the Burst Types topic for more information about the types of bursts.
        ...
        /// 
        /// </summary>
        public int GetFilterWidth(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.FilterWidth, channel, out value);
        }

        /// <summary>
        ///Specifies the type of the burst as specified in section 5.2 of 3GPP TS 45.001 specifications.
        ///    Refer to the Burst Types topic for more information about the types of bursts.
        ///    The default value is NIEDGESA_VAL_BURST_TYPE_NORMAL_BURST.
        ///    Set Function: niEDGESA_SetBurstType
        ///    Get Function: niEDGESA_GetBurstType
        /// 
        /// </summary>
        public int SetBurstType(string channel, int value)
        {
            return SetInt32(niEDGESAProperties.BurstType, channel, value);
        }
        /// <summary>
        ///Specifies the type of the burst as specified in section 5.2 of 3GPP TS 45.001 specifications.
        ///    Refer to the Burst Types topic for more information about the types of bursts.
        ...
        {
            return GetInt32(niEDGESAProperties.BurstType, channel, out value);
        }

        /// <summary>
        ///Returns the average peak error vector magnitude (EVM), multiplied by 100.
        ///    To perform this measurement, the toolkit computes the peak EVM of all the bursts and returns the maximum of these values.
        ///    Get Function: niEDGESA_EVMGetMeanPeakEVM
        /// 
        /// </summary>
        public int GetResultsMeanPeakEvm(string channel, out double value)
        {
            return GetDouble(niEDGESAProperties.ResultsMeanPeakEvm, channel, out value);
        }

        /// <summary>
        ///Indicates the starting index of the useful portion of the burst.
        ///    Refer to the Useful Portion of a Burst topic for more information about the useful portion of a burst.
        ///    Get Function: niEDGESA_PvTGetStartIndex
        /// 
        /// </summary>
        public int GetPvtResultsStartIndex(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.PvtResultsStartIndex, channel, out value);
        }

        /// <summary>
        ///Indicates the index at the end of the useful portion of the burst.
        ///    Refer to the Useful Portion of a Burst topic for more information about the useful portion of a burst.
        ///    Get Function: niEDGESA_PvTGetStopIndex
        /// 
        /// </summary>
        public int GetPvtResultsStopIndex(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.PvtResultsStopIndex, channel, out value);
        }

        /// <summary>
        ///Indicates the transition index from symbol 13 to symbol 14 in the training sequence.
        ///    Get Function: niEDGESA_PvTGetZeroIndex
        /// 
        /// </summary>
        public int GetPvtResultsZeroIndex(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.PvtResultsZeroIndex, channel, out value);
        }
        ...
        ///     The default value is NIEDGESA_VAL_FALSE.
        ///    Set Function: niEDGESA_TxPSetAllTracesEnabled
        ///    Get Function: niEDGESA_TxPGetAllTracesEnabled
        /// 
        /// </summary>
        public int SetTxpAllTracesEnabled(string channel, bool value)
        {
            return SetInt32(niEDGESAProperties.TxpAllTracesEnabled, channel, Convert.ToInt32(value));
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public int GetTxpAllTracesEnabled(string channel, out bool value)
        {
            int booleanValue;
            int status = GetInt32(niEDGESAProperties.TxpAllTracesEnabled, channel,  out booleanValue);
            value = Convert.ToBoolean(booleanValue);
            return status;
        }
        ...
        ///    The default value is NIEDGESA_VAL_TXP_LINEAR_AVERAGING.
        ///    Set Function: niEDGESA_TxPSetAveragingMode
        ///    Get Function: niEDGESA_TxPGetAveragingMode
        /// 
        /// </summary>
        public int SetTxpAveragingMode(string channel, int value)
        {
            return SetInt32(niEDGESAProperties.TxpAveragingMode, channel,  value);
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public int GetTxpAveragingMode(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.TxpAveragingMode, channel,  out value);
        }
        ...
        ///     The default value is NIEDGESA_VAL_FALSE.
        ///    Set Function: niEDGESA_TxPSetMeasurementEnabled
        ///    Get Function: niEDGESA_TxPGetMeasurementEnabled
        /// 
        /// </summary>
        public int SetTxpEnabled(string channel, bool value)
        {
            return SetInt32(niEDGESAProperties.TxpEnabled, channel, Convert.ToInt32(value));
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public int GetTxpEnabled(string channel, out bool value)
        {
            int booleanValue;
            int status = GetInt32(niEDGESAProperties.TxpEnabled, channel,  out booleanValue);
            value = Convert.ToBoolean(booleanValue);
            return status;
        }
        ...
        ///Specifies the threshold value. This value is in dBm if the NIEDGESA_TXP_MEASUREMENT_THRESHOLD_TYPE attribute is set to NIEDGESA_VAL_ABSOLUTE and in dB if the    NIEDGESA_TXP_MEASUREMENT_THRESHOLD_TYPE attribute is set to NIEDGESA_VAL_RELATIVE.
        ///    If the NIEDGESA_TXP_MEASUREMENT_THRESHOLD_TYPE attribute is set to NIEDGESA_VAL_ABSOLUTE, the toolkit uses the NIEDGESA_TXP_MEASUREMENT_THRESHOLD_LEVEL attribute as the threshold level.    The toolkit assumes this value to be in dBm. If the NIEDGESA_TXP_MEASUREMENT_THRESHOLD_TYPE attribute is set to NIEDGESA_VAL_RELATIVE, the threshold level is relative to the    peak value in the acquired waveform.
        ///    Set Function: niEDGESA_TxPSetMeasurementThresholdLevel
        ///    Get Function: niEDGESA_TxPGetMeasurementThresholdLevel
        /// 
        /// </summary>
        public int SetTxpMeasurementThresholdLevel(string channel, double value)
        {
            return SetDouble(niEDGESAProperties.TxpMeasurementThresholdLevel, channel,  value);
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public int GetTxpMeasurementThresholdLevel(string channel, out double value)
        {
            return GetDouble(niEDGESAProperties.TxpMeasurementThresholdLevel, channel,  out value);
        }

        /// <summary>

        ///Specifies the type of threshold used for transmit power (TxP) measurements.
        ///    The toolkit considers only the points that are above the threshold level that you specify in the    NIEDGESA_TXP_MEASUREMENT_THRESHOLD_LEVEL attribute for performing transmit power measurements.
        ///    The default value is NIEDGESA_VAL_RELATIVE.
        ///    Set Function: niEDGESA_TxPSetMeasurementThresholdType
        ///    Get Function: niEDGESA_TxPGetMeasurementThresholdType
        /// 
        /// </summary>
        public int SetTxpMeasurementThresholdType(string channel, int value)
        {
            return SetInt32(niEDGESAProperties.TxpMeasurementThresholdType, channel,  value);
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public int GetTxpMeasurementThresholdType(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.TxpMeasurementThresholdType, channel,  out value);
        }
        ...
        ///    The default value is 10. Valid values are 1 to 10,000 (inclusive).
        ///    Set Function: niEDGESA_TxPSetNumberOfAverages
        ///    Get Function: niEDGESA_TxPGetNumberOfAverages
        /// 
        /// </summary>
        public int SetTxpNumberOfAverages(string channel, int value)
        {
            return SetInt32(niEDGESAProperties.TxpNumberOfAverages, channel,  value);
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public int GetTxpNumberOfAverages(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.TxpNumberOfAverages, channel,  out value);
        }
        ...
        ///    Set Function: niEDGESA_TxPSetRBWFilterBandwidth
        ///    Get Function: niEDGESA_TxPGetRBWFilterBandwidth
        /// 
        /// </summary>
        public int SetTxpRbwFilterBandwidth(string channel, double value)
        {
            return SetDouble(niEDGESAProperties.TxpRbwFilterBandwidth, channel,  value);
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public int GetTxpRbwFilterBandwidth(string channel, out double value)
        {
            return GetDouble(niEDGESAProperties.TxpRbwFilterBandwidth, channel,  out value);
        }

        /// <summary>

        ///Specifies the type of front end RBW filter used for transmit power (TxP) measurements.
        ///    Note: This is the first filter that is applied on the acquired waveform in the NIEDGESA_AnalyzeIQComplexF64 function.
        ///    The default value is NIEDGESA_VAL_FILTER_TYPE_GAUSSIAN.
        ///    Set Function: niEDGESA_TxPSetRBWFilterType
        ///    Get Function: niEDGESA_TxPGetRBWFilterType
        /// 
        /// </summary>
        public int SetTxpRbwFilterType(string channel, int value)
        {
            return SetInt32(niEDGESAProperties.TxpRbwFilterType, channel,  value);
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public int GetTxpRbwFilterType(string channel, out int value)
        {
            return GetInt32(niEDGESAProperties.TxpRbwFilterType, channel,  out value);
        }

        /// <summary>

        ///Returns the average power, in dBm, in the useful portion of the burst.
        ///    Refer to the Useful Portion of a Burst topic for more information about the useful portion of the burst.
        ///    Get Function: niEDGESA_TxPGetAveragePower
        /// 
        /// </summary>
        public int GetTxpResultsAveragePower(string channel, out double value)
        {
            return GetDouble(niEDGESAProperties.TxpResultsAveragePower, channel,  out value);
        }

        /// <summary>
        ///Returns the maximum power, in dBm. The toolkit calculates the average over a specified number of averages and returns the    maximum of these averaged values.
        ///    Get Function: niEDGESA_TxPGetMaximumPower
        /// 
        /// </summary>
        public int GetTxpResultsMaximumPower(string channel, out double value)
        {
            return GetDouble(niEDGESAProperties.TxpResultsMaximumPower, channel,  out value);
        }

        /// <summary>
        ///Returns the minimum power, in dBm. The toolkit calculates the average over a specified number of averages and returns    the minimum of these averaged values.
        ///    Get Function: niEDGESA_TxPGetMinimumPower
        /// 
        /// </summary>
        public int GetTxpResultsMinimumPower(string channel, out double value)
        {
            return GetDouble(niEDGESAProperties.TxpResultsMinimumPower, channel,  out value);
        }
        ...
        ///    Set Function: niEDGESA_SetTriggerDelay
        ///    Get Function: niEDGESA_GetTriggerDelay
        /// 
        /// </summary>
        public int SetTriggerDelay(string channel, double value)
        {
            return SetDouble(niEDGESAProperties.TriggerDelay, channel, value);
        }
        ...
        {
            return GetDouble(niEDGESAProperties.TriggerDelay, channel, out value);
        }
        ...
        private class PInvoke
        {
            ...
            /*New PInvokes in v1.1*/
            #region v1.1 PInvokes
            [DllImport(nativeDllName, EntryPoint = "niEDGESA_SelectMeasurementsWithTraces", CallingConvention = CallingConvention.StdCall)]
            public static extern int niEDGESA_SelectMeasurementsWithTraces(HandleRef session, UInt32 measurements, int enableTraces);


            [DllImport(nativeDllName, EntryPoint = "niEDGESA_TxPGetAveragePowerTrace", CallingConvention = CallingConvention.StdCall)]
            public static extern int niEDGESA_TxPGetAveragePowerTrace(HandleRef session, out double t0, out double dt, [Out] double[] averagePower, int dataArraySize, out int actualNumDataArrayElements);

            [DllImport(nativeDllName, EntryPoint = "niEDGESA_TxPGetCurrentIterationAcquiredIQWaveformTrace", CallingConvention = CallingConvention.StdCall)]
            public static extern int niEDGESA_TxPGetCurrentIterationAcquiredIQWaveformTrace(HandleRef session, out double t0, out double dt, [Out] niComplexNumber acquiredIQWaveform, int dataArraySize, out int actualNumDataArrayElements);

            [DllImport(nativeDllName, EntryPoint = "niEDGESA_RFSAMeasure", CallingConvention = CallingConvention.StdCall)]
            public static extern int niEDGESA_RFSAMeasure(HandleRef session, System.Runtime.InteropServices.HandleRef rFSAHandle, double timeout);
    ...
    public class niEDGESAConstants
    {
        ...
        /*New constants in v1.1*/
        #region v1.1 Constants

        public const int BurstSynchronizationMethodTsc = 0;

        public const int BurstSynchronizationMethodAmplitude = 1;
        
        public const int Unknown = 8;

        public const int BurstTypeNormalBurst = 0;

        public const int BurstTypeHighDataRateBurst = 1;

        public const int ModulationType8psk = 0;

        public const int ModulationTypeQpsk = 1;

        public const int ModulationType16qam = 2;

        public const int ModulationType32qam = 3;

        public const int FilterWidthNarrow = 0;

        public const int FilterWidthWide = 1;

        public const int PvtLinearAveraging = 0;

        public const int Absolute = 0;

        public const int Relative = 1;

        public const int OrfsLinearAveraging = 0;

        public const int NitxpLinearAveraging = 0;

        public const int NitxpLogAveraging = 1;

        public const int NitxpPeakHoldAveraging = 2;

        public const int NitxpMinimumHoldAveraging = 3;
    ...
    public enum niEDGESAProperties
    {
        ...
        /*New properties in v1.1*/
        #region v1.1 Properties
        
        /// <summary>
        /// int
        /// </summary>
        BurstSynchronizationMethod = 259,
        ...
        /// double
        /// </summary>
        ResultsMeanPeakEvm = 12,

        /// <summary>
        /// int
        /// </summary>
        PvtResultsStartIndex = 86,

        /// <summary>
        /// int
        /// </summary>
        PvtResultsStopIndex = 87,

        /// <summary>
        /// int
        /// </summary>
        PvtResultsZeroIndex = 88,

        /// <summary>
        /// int
        /// </summary>
        TxpAllTracesEnabled = 669,

        /// <summary>
        /// int
        /// </summary>
        TxpAveragingMode = 622,
        ...
        /// double
        /// </summary>
        TxpMeasurementThresholdLevel = 618,

        /// <summary>
        /// int
        /// </summary>
        TxpMeasurementThresholdType = 617,

        /// <summary>
        /// int
        /// </summary>
        TxpNumberOfAverages = 619,

        /// <summary>
        /// double
        /// </summary>
        TxpRbwFilterBandwidth = 616,

        /// <summary>
        /// int
        /// </summary>
        TxpRbwFilterType = 615,

        /// <summary>
        /// double
        /// </summary>
        TxpResultsAveragePower = 623,

        /// <summary>
        /// double
        /// </summary>
        TxpResultsMaximumPower = 626,

        /// <summary>
        /// double
        /// </summary>
        TxpResultsMinimumPower = 627,
