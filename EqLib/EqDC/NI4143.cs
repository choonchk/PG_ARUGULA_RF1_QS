...
namespace EqLib
{
    public partial class EqDC
    {
        public class NI4143 : iEqDC
        {
            ...
            public NI4143(string VisaAlias, string ChanNumber, string PinName, byte Site, bool Reset)
            {
                try
                {
            ...
            public void SetupContinuity(double currentForce)
            {
                ...
                SetupCurrentMeasure(0.0005, TriggerLine.None);
            }
