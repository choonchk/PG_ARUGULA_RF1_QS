...
namespace NationalInstruments.ModularInstruments.Interop
{
    ...
    public class niRFSG : object, System.IDisposable
    {
        ...
        /// </remarks>
        public int CreateDeembeddingSParameterTableS2pFile(string port, string tableName, string s2pFilePath, int sParameterOrientation)
        {
            int pInvokeResult = PInvoke.CreateDeembeddingSParameterTableS2pFile(this._handle, port, tableName, s2pFilePath, sParameterOrientation);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        }
        ...
        /// If you only create one table, NI-RFSG automatically selects that table to de-embed the measurement.
        /// </remarks>
        public int CreateDeembeddingSParameterTableArray(string port, string tableName, double[] frequencies, niComplexNumber[,,] sParameterTable, int sParameterOrientation)
        {
            int numberOfPorts = 0;
            int numberOfRows = sParameterTable.GetLength(1);
            int numberOfCols = sParameterTable.GetLength(2);
            if (numberOfRows == numberOfCols)
            {
                numberOfPorts = numberOfRows;
            }
            int pInvokeResult = PInvoke.CreateDeembeddingSParameterTableArray(this._handle, port, tableName, frequencies, frequencies.Length, sParameterTable, sParameterTable.Length, numberOfPorts, sParameterOrientation);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        }
        ...
        public int DeleteDeembeddingTable(string port, string tableName)
        {
            int pInvokeResult = PInvoke.DeleteDeembeddingTable(this._handle, port, tableName);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        }
        ...
        /// </summary>
        public int DeleteAllDeembeddingTables()
        {
            int pInvokeResult = PInvoke.DeleteAllDeembeddingTables(this._handle);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        }
        ...
        /// </remarks>
        public int ConfigureDeembeddingTableInterpolationNearest(string port, string tableName)
        {
            int pInvokeResult = PInvoke.ConfigureDeembeddingTableInterpolationNearest(this._handle, port, tableName);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        }
        ...
        /// </remarks>
        public int ConfigureDeembeddingTableInterpolationLinear(string port, string tableName, int format)
        {
            int pInvokeResult = PInvoke.ConfigureDeembeddingTableInterpolationLinear(this._handle, port, tableName, format);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        }
        ...
        /// </remarks>
        public int ConfigureDeembeddingTableInterpolationSpline(string port, string tableName)
        {
            int pInvokeResult = PInvoke.ConfigureDeembeddingTableInterpolationSpline(this._handle, port, tableName);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        }
        ...
        /// </remarks>
        public int GetDeembeddingSParameters(ref niComplexNumber[,] sParameters)
        {
            niComplexNumber[] internalSParameters = null;
            int sParametersSize = 0;

            int numberOfSParametersReturned = 0;
            int numberOfPorts = 0;
            ...
            pInvokeResult = PInvoke.TestForError(this._handle, PInvoke.GetDeembeddingSParameters(this._handle, internalSParameters, sParametersSize, out numberOfSParametersReturned, out numberOfPorts));

            if ((sParameters == null) || (sParameters.Length != numberOfSParametersReturned))
            {
                internalSParameters = new niComplexNumber[numberOfSParametersReturned];
                pInvokeResult = PInvoke.GetDeembeddingSParameters(Handle, internalSParameters, numberOfSParametersReturned, out sParametersSize, out numberOfPorts);
                rows = numberOfPorts;
                cols = numberOfPorts;
                sParameters = new niComplexNumber[rows, cols];
        ...
        /// 
        /// </remarks>
        public int ResetWithOptions(int stepsToOmit)
        {
        ...
        public int GetString(niRFSGProperties propertyId, string repeatedCapabilityOrChannel, out string val)
        {
            ...
            int pInvokeResult = 0;
            System.Text.StringBuilder newVal = new System.Text.StringBuilder(512);
            int size = PInvoke.GetAttributeViString(this._handle, repeatedCapabilityOrChannel, ((int)(propertyId)), 0, newVal);
            if ((size < 0))
            {
        ...
        /// </summary>
        public int SetDeembeddingType(string channel, int value)
        {
            return this.SetInt32(niRFSGProperties.AttrDeembeddingType, channel, value);
        }
        /// <summary>
        /// Gets the type of de-embedding to apply to measurements.
        /// </summary>
        public int GetDeembeddingType(string channel, out int value)
        {
            return this.GetInt32(niRFSGProperties.AttrDeembeddingType, channel, out value);
        }

        /// <summary>
        /// Sets the de-embedding table to apply to the measurements.
        /// </summary>
        public int SetDeembeddingSelectedTable(string channel, string value)
        {
            return this.SetString(niRFSGProperties.AttrDeembeddingSelectedTable, channel, value);
        }
        /// <summary>
        /// Gets the de-embedding table to apply to the measurements.
        /// </summary>
        public int GetDeembeddingSelectedTable(string channel, out string value)
        {
            return this.GetString(niRFSGProperties.AttrDeembeddingSelectedTable, channel, out value);
        }

        /// <summary>
        /// Sets which port to configure to acquire a signal.
        /// </summary>
        public int SetSelectedPorts(string channel, string value)
        {
            return this.SetString(niRFSGProperties.AttrSelectedPorts, channel, value);
        }

        /// <summary>
        /// Gets which port to configure to acquire a signal.
        /// </summary>
        public int GetSelectedPorts(string channel, out string value)
        {
            return this.GetString(niRFSGProperties.AttrSelectedPorts, channel, out value);
        }

        /// <summary>
        /// Gets a comma-separated list of the ports available for use based on your instrument configuration.
        /// </summary>
        public int GetAvailablePorts(string channel, out string value)
        {
            return this.GetString(niRFSGProperties.AttrAvailablePorts, channel, out value);
        }
        ...
        {
            return this.GetString(niRFSGProperties.AttrFpgaTargetName, channel, out value);
        }
        ...
        {
            return GetDouble(niRFSGProperties.AttrDeviceInstantaneousBandwidth, channel, out value);
        }
        ...
        {
            return GetDouble(niRFSGProperties.AttrLOFrequency, channel, out value);
        }

        /// <summary>
        /// Sets the step size for tuning the internal voltage-controlled oscillator (VCO) used to generate the LO signal.
        /// </summary>
        public int SetLOVcoFrequencyStepSize(string channel, double value)
        {
        ...
        /// </summary>
        public int GetLOVcoFrequencyStepSize(string channel, out double value)
        {
            return GetDouble(niRFSGProperties.AttrLOVcoFrequencyStepSize, channel, out value);
        }
        ...
        /// </summary>
        public int SetUpconverterFrequencyOffsetMode(string channel, int value)
        {
            return this.SetInt32(niRFSGProperties.AttrUpconverterFrequencyOffsetMode, channel, value);
        }
        /// <summary>
        ...
        /// </summary>
        public int GetUpconverterFrequencyOffsetMode(string channel, out int value)
        {
            return this.GetInt32(niRFSGProperties.AttrUpconverterFrequencyOffsetMode, channel, out value);
        }
        ...
        /// </summary>
        public int SetThermalCorrectionHeadroomRange(string channel, double value)
        {
        ...
        /// Specifies the expected thermal operating range of the instrument from the self-calibration temperature, in degrees Celsius, returned from the DeviceTemperature property.
        /// </summary>
        public int GetThermalCorrectionHeadroomRange(string channel, out double value)
        {
            return GetDouble(niRFSGProperties.AttrThermalCorrectionHeadroomRange, channel, out value);
        }
        ...
        private class PInvoke
        {
            ...
            [DllImport(nativeDllName32, EntryPoint = "niRFSG_CreateDeembeddingSparameterTableS2PFile", CallingConvention = CallingConvention.StdCall)]
            public static extern int CreateDeembeddingSParameterTableS2pFile32(HandleRef instrumentHandle, string port, string tableName, string s2pFilePath, int sParameterOrientation);

            [DllImport(nativeDllName64, EntryPoint = "niRFSG_CreateDeembeddingSparameterTableS2PFile", CallingConvention = CallingConvention.StdCall)]
            public static extern int CreateDeembeddingSParameterTableS2pFile64(HandleRef instrumentHandle, string port, string tableName, string s2pFilePath, int sParameterOrientation);

            public static int CreateDeembeddingSParameterTableS2pFile(HandleRef instrumentHandle, string port, string tableName, string s2pFilePath, int sParameterOrientation)
            {
                if (Is64BitProcess)
            ...
            [DllImport(nativeDllName32, EntryPoint = "niRFSG_CreateDeembeddingSparameterTableArray", CallingConvention = CallingConvention.StdCall)]
            public static extern int CreateDeembeddingSParameterTableArray32(HandleRef instrumentHandle, string port, string tableName, double[] frequencies, int frequenciesSize,
            niComplexNumber[,,] sParameterTable, int sParameterTableSize, int numberOfPorts, int sParameterOrientation);

            [DllImport(nativeDllName64, EntryPoint = "niRFSG_CreateDeembeddingSparameterTableArray", CallingConvention = CallingConvention.StdCall)]
            public static extern int CreateDeembeddingSParameterTableArray64(HandleRef instrumentHandle, string port, string tableName, double[] frequencies, int frequenciesSize,
                niComplexNumber[,,] sParameterTable, int sParameterTableSize, int numberOfPorts, int sParameterOrientation);

            public static int CreateDeembeddingSParameterTableArray(HandleRef instrumentHandle, string port, string tableName, double[] frequencies, int frequenciesSize,
                niComplexNumber[,,] sParameterTable, int sParameterTableSize, int numberOfPorts, int sParameterOrientation)
            {
                if (Is64BitProcess)
                    return CreateDeembeddingSParameterTableArray64(instrumentHandle, port, tableName, frequencies, frequenciesSize, sParameterTable, sParameterTableSize, numberOfPorts, sParameterOrientation);
                else
                    return CreateDeembeddingSParameterTableArray32(instrumentHandle, port, tableName, frequencies, frequenciesSize, sParameterTable, sParameterTableSize, numberOfPorts, sParameterOrientation);
            }

            [DllImport(nativeDllName32, EntryPoint = "niRFSG_DeleteDeembeddingTable", CallingConvention = CallingConvention.StdCall)]
            public static extern int DeleteDeembeddingTable32(HandleRef instrumentHandle, string port, string tableName);

            [DllImport(nativeDllName64, EntryPoint = "niRFSG_DeleteDeembeddingTable", CallingConvention = CallingConvention.StdCall)]
            public static extern int DeleteDeembeddingTable64(HandleRef instrumentHandle, string port, string tableName);

            public static int DeleteDeembeddingTable(HandleRef instrumentHandle, string port, string tableName)
            {
                if (Is64BitProcess)
            ...
            [DllImport(nativeDllName32, EntryPoint = "niRFSG_DeleteAllDeembeddingTables", CallingConvention = CallingConvention.StdCall)]
            public static extern int DeleteAllDeembeddingTables32(HandleRef instrumentHandle);

            [DllImport(nativeDllName64, EntryPoint = "niRFSG_DeleteAllDeembeddingTables", CallingConvention = CallingConvention.StdCall)]
            public static extern int DeleteAllDeembeddingTables64(HandleRef instrumentHandle);

            public static int DeleteAllDeembeddingTables(HandleRef instrumentHandle)
            {
                if (Is64BitProcess)
            ...
            [DllImport(nativeDllName32, EntryPoint = "niRFSG_ConfigureDeembeddingTableInterpolationNearest", CallingConvention = CallingConvention.StdCall)]
            public static extern int ConfigureDeembeddingTableInterpolationNearest32(HandleRef instrumentHandle, string port, string tableName);

            [DllImport(nativeDllName64, EntryPoint = "niRFSG_ConfigureDeembeddingTableInterpolationNearest", CallingConvention = CallingConvention.StdCall)]
            public static extern int ConfigureDeembeddingTableInterpolationNearest64(HandleRef instrumentHandle, string port, string tableName);

            public static int ConfigureDeembeddingTableInterpolationNearest(HandleRef instrumentHandle, string port, string tableName)
            {
                if (Is64BitProcess)
            ...
            [DllImport(nativeDllName32, EntryPoint = "niRFSG_ConfigureDeembeddingTableInterpolationLinear", CallingConvention = CallingConvention.StdCall)]
            public static extern int ConfigureDeembeddingTableInterpolationLinear32(HandleRef instrumentHandle, string port, string tableName, int format);

            [DllImport(nativeDllName64, EntryPoint = "niRFSG_ConfigureDeembeddingTableInterpolationLinear", CallingConvention = CallingConvention.StdCall)]
            public static extern int ConfigureDeembeddingTableInterpolationLinear64(HandleRef instrumentHandle, string port, string tableName, int format);

            public static int ConfigureDeembeddingTableInterpolationLinear(HandleRef instrumentHandle, string port, string tableName, int format)
            {
                if (Is64BitProcess)
            ...
            [DllImport(nativeDllName32, EntryPoint = "niRFSG_ConfigureDeembeddingTableInterpolationSpline", CallingConvention = CallingConvention.StdCall)]
            public static extern int ConfigureDeembeddingTableInterpolationSpline32(HandleRef instrumentHandle, string port, string tableName);

            [DllImport(nativeDllName64, EntryPoint = "niRFSG_ConfigureDeembeddingTableInterpolationSpline", CallingConvention = CallingConvention.StdCall)]
            public static extern int ConfigureDeembeddingTableInterpolationSpline64(HandleRef instrumentHandle, string port, string tableName);

            public static int ConfigureDeembeddingTableInterpolationSpline(HandleRef instrumentHandle, string port, string tableName)
            {
                if (Is64BitProcess)
            ...
            [DllImport(nativeDllName32, EntryPoint = "niRFSG_GetDeembeddingSparameters", CallingConvention = CallingConvention.StdCall)]
            public static extern int GetDeembeddingSParameters32(HandleRef instrumentHandle, [Out] niComplexNumber[] sParameters, int sParametersArraySize, out int numberOfSParametersReturned, out int numberOfPorts);

            [DllImport(nativeDllName64, EntryPoint = "niRFSG_GetDeembeddingSparameters", CallingConvention = CallingConvention.StdCall)]
            public static extern int GetDeembeddingSParameters64(HandleRef instrumentHandle, [Out] niComplexNumber[] sParameters, int sParametersArraySize, out int numberOfSParametersReturned, out int numberOfPorts);

            public static int GetDeembeddingSParameters(HandleRef instrumentHandle, [Out] niComplexNumber[] sParameters, int sParametersArraySize, out int numberOfSParametersReturned, out int numberOfPorts)
            {
                if (Is64BitProcess)
                    return GetDeembeddingSParameters64(instrumentHandle, sParameters, sParametersArraySize, out numberOfSParametersReturned, out numberOfPorts);
                else
                    return GetDeembeddingSParameters32(instrumentHandle, sParameters, sParametersArraySize, out numberOfSParametersReturned, out numberOfPorts);
            }
            ...
            [DllImport(nativeDllName32, EntryPoint = "niRFSG_ResetWithOptions", CallingConvention = CallingConvention.StdCall)]
            public static extern int ResetWithOptions32(System.Runtime.InteropServices.HandleRef instrumentHandle, int stepsToOmit);
            [DllImport(nativeDllName64, EntryPoint = "niRFSG_ResetWithOptions", CallingConvention = CallingConvention.StdCall)]
            public static extern int ResetWithOptions64(System.Runtime.InteropServices.HandleRef instrumentHandle, int stepsToOmit);

            public static int ResetWithOptions(System.Runtime.InteropServices.HandleRef instrumentHandle, int stepsToOmit)
            {
                if (Is64BitProcess)
    ...
    public class niRFSGConstants
    {
        ...
        /// 
        /// </summary>
        public const int DeembeddingTypeNone = 25000;

        /// <summary>
        /// 
        /// </summary>
        public const int DeembeddingTypeScalar = 25001;

        /// <summary>
        /// 
        /// </summary>
        public const int DeembeddingTypeVector = 25002;

        /// <summary>
        /// 
        /// </summary>
        public const int SParameterOrientationPort1TowardsDut = 24000;

        /// <summary>
        /// 
        /// </summary>
        public const int SParameterOrientationPort2TowardsDut = 24001;

        /// <summary>
        /// 
        /// </summary>
        public const int LinearInterpolationFormatRealAndImaginary = 26000;

        /// <summary>
        /// 
        /// </summary>
        public const int LinearInterpolationFormatMagnitudeAndPhase = 26001;

        /// <summary>
        /// 
        /// </summary>
        public const int LinearInterpolationFormatMagnitudeInDecibelAndPhase = 26002;
        ...
        /// 
        /// </summary>
        public const string SGSAShared = "SGSAShared";

        /// <summary>
        /// 
        /// </summary>
        public const int UpconverterFrequencyOffsetModeAuto = -1;

        /// <summary>
        /// 
        /// </summary>
        public const int UpconverterFrequencyOffsetModeUserDefined = 5001;

        /// <summary>
        /// 
        /// </summary>
        public const int UpconverterFrequencyOffsetModeEnable = 1;

        /// <summary>
        /// 
        /// </summary>
        public const int ResetWithOptionsNone = 0x0;

        /// <summary>
        /// 
        /// </summary>
        public const int ResetWithOptionsWaveforms = 0x1;

        /// <summary>
        /// 
        /// </summary>
        public const int ResetWithOptionsScripts = 0x2;

        /// <summary>
        /// 
        /// </summary>
        public const int ResetWithOptionsRoutes = 0x4;

        /// <summary>
        /// 
        /// </summary>
        public const int ResetWithOptionsDeembeddingTables = 0x8;
