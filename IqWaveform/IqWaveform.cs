    ...
    public static class IQ
    {
        ...
        public static bool Load(string ModStd, string WvfrmName, bool Model)
        {
            lock (Mem)
            {
                ...
                List<double> Markers1 = new List<double> { 0 };
                ...
                switch (ModStd)
                {
                    ...
                    case "LTUQ":
                        ...
                        switch (WvfrmName)
                        {
                            ...
                            case "10M12RB0S":
                                ...
                                SubsetLengthSeconds = 0.499934895833333e-3; //org 0.499934895833333e-3;
                                VsgIQrate = 15.36e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.499934895833333e-3; //org 0.499934895833333e-3;
                                IntialServoMeasTime = 0.050e-3;
                                FinalServoMeasTime = 0.499934895833333e-3; //org 0.499934895833333e-3;
                                Rbw = 100e3;
                                EVM_Type = "LTE";
                                break;
                            ...
                            case "20M100RB": //CCDF
                                RefChBW = 18e6;
                                AdjChans.Add("ACLR1", 10.8e6, 1.28e6);
                                AdjChans.Add("ACLR2", 12.4e6, 1.28e6);
                    ...
                    case "LTU1":
                        ...
                        switch (WvfrmName)
                        {
                            ...
                            case "10M50RB": //CCDF
                                ...
                                Ifile = "I_LTU1_10M50R20M.txt";
                                Qfile = "Q_LTU1_10M50R20M.txt";
                                Markers = new List<double> { 0 };
                                SubsetStartSeconds = 3.112265625e-3;
                                SubsetLengthSeconds = 0.399934895833333e-3;
                                VsgIQrate = 15.36e6m;
                    ...
                    case "LTU6":
                        ...
                        switch (WvfrmName)
                        {
                            ...
                            case "10M50RB": //CCDF
                                ...
                                Ifile = "I_LTU6_10M50R0S27M_REF.txt";
                                Qfile = "Q_LTU6_10M50R0S27M_REF.txt";
                                Markers = new List<double> { 0 };
                                SubsetStartSeconds = 3.112265625e-3;
                                SubsetLengthSeconds = 0.399934895833333e-3;
                                VsgIQrate = 15.36e6m;
                    ...
                    case "NCTUQ":
                        ...
                        switch (WvfrmName)
                        {
                            case "SC30B20M51R0S3X10SLOT1CFR7":
                                ...
                                Ifile = "I_NCTUQ_SC30B20M51R0S3X_10_SLOT1_CFR7.txt";
                                Qfile = "Q_NCTUQ_SC30B20M51R0S3X_10_SLOT1_CFR7.txt";
                                Markers = new List<double> { 0 };

                                SubsetStartSeconds = 0.6875e-3;//0.5e-3;
                                SubsetLengthSeconds = 0.199989149e-3;//0.5e-3;

                                VsgIQrate = 92.16e6m; //61.44e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.5e-3;//0.554980469e-3;
                                IntialServoMeasTime = 0.125e-3; //0.01e-3
                                FinalServoMeasTime = 0.5e-3;
                                EVM_Type = "NR";
                                break;

                            case "SC30B40M106R0S3X10SLOT1CFR7":
                                RefChBW = 38.895e6;
                                AdjChans.Add("ACLR1", 22.5e6, 3.84e6);
                                AdjChans.Add("ACLR2", 27.5e6, 3.84e6);
                                AdjChans.Add("E-ACLR", 40e6, 38.895e6);

                                Ifile = "I_NCTUQ_SC30B40M106R0S3X_10_SLOT1_CFR7.txt";
                                Qfile = "Q_NCTUQ_SC30B40M106R0S3X_10_SLOT1_CFR7.txt";
                                Markers = new List<double> { 0 };

                                SubsetStartSeconds = 0.754882813e-3;//0.5e-3;
                                SubsetLengthSeconds = 0.199994575e-3;//0.5e-3;

                                VsgIQrate = 184.32e6m; //61.44e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = .5e-3;
                                IntialServoMeasTime = .125e-3; //0.01e-3
                                FinalServoMeasTime = .5e-3;
                                EVM_Type = "NR";
                                break;
                            ...
                            case "SC30B20M51R0S3X_10_SLOT1_CFR7":
                                RefChBW = 19.095e6;
                                AdjChans.Add("ACLR1", 12.5e6, 3.84e6);
                                AdjChans.Add("ACLR2", 17.5e6, 3.84e6);
                                AdjChans.Add("E-ACLR", 20e6, 19.095e6);
                                ...
                                SubsetStartSeconds = 0.5e-3;// 8526.464844e-6;
                                SubsetLengthSeconds = 0.5e-3;// 0.56SC30B20M51R0S3X_10_SLOT1_CFR79954427e-3;

                                VsgIQrate = 92.16e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.5e-3;
                                IntialServoMeasTime = 0.1e-3;
                                FinalServoMeasTime = 0.5e-3;// 0.569954427e-3;
                                EVM_Type = "NR";
                                break;

                            case "SC30B40M106R0S3X_10_SLOT1_CFR7":
                                RefChBW = 38.895e6;
                                AdjChans.Add("ACLR1", 22.5e6, 3.84e6);
                                AdjChans.Add("ACLR2", 27.5e6, 3.84e6);
                                AdjChans.Add("E-ACLR", 40e6, 38.895e6);
                                ...
                                SubsetStartSeconds = 0.5e-3;
                                SubsetLengthSeconds = 0.5e-3;

                                VsgIQrate = 184.32e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.5-3;
                                IntialServoMeasTime = 0.1e-3;
                                FinalServoMeasTime = 0.5e-3;
                                EVM_Type = "NR";
                                break;
                    ...
                    case "NCTU2":
                        ...
                        switch (WvfrmName)
                        {
                            case "SC30B20M51R0S3X10SLOT1CFR9P5EVM":

                                RefChBW = 19.095e6;
                                AdjChans.Add("ACLR1", 12.5e6, 3.84e6);
                                AdjChans.Add("ACLR2", 17.5e6, 3.84e6);
                                AdjChans.Add("E-ACLR", 20e6, 19.056e6);
                                
                                Ifile = "I_NCTU2_SC30B20M51R0S3X_10_SLOT1_CFR9.5.txt";
                                Qfile = "Q_NCTU2_SC30B20M51R0S3X_10_SLOT1_CFR9.5.txt";
                                Markers = new List<double> { 0 };

                                SubsetStartSeconds = 0.49955512e-3;//0.5000108e-3;// 4325.2197e-6;
                                SubsetLengthSeconds = 0.0005000455;// 589.9902e-6; //0.0045 //0.0025
                                VsgIQrate = 92.16e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.0005000455; //0.0025
                                IntialServoMeasTime = 0.1e-3; //0.01e-3
                                FinalServoMeasTime = 0.0005000455; // 589.9902e-6 //0.0035 //0.0025
                                EVM_Type = "NR";

                                break;

                            case "SC30B20M51R0S3X10SLOT1CFR9P5FASTEVM":
                                ...
                                //SubsetStartSeconds = 0.49955512e-3;//0.5000108e-3;// 4325.2197e-6;
                                //SubsetLengthSeconds = 0.0005000455;// 589.9902e-6; //0.0045 //0.0025
                                //SubsetStartSeconds = 0.71e-3; //0.51e-3; // [BurhanEVM-26Aug]
                                //SubsetLengthSeconds = 0.000025; // [BurhanEVM-26Aug]
                                SubsetStartSeconds = 0.734544e-3; // [BurhanEVM-10Sept]
                                SubsetLengthSeconds = 0.024987e-3; // [BurhanEVM-10Sept]
                                VsgIQrate = 92.16e6m;
                                IsBursted = true;
                                //ServoWindowLengthSec = 0.0005000455; //0.0025
                                //IntialServoMeasTime = 0.1e-3; //0.01e-3
                                //FinalServoMeasTime = 0.0005000455; // 589.9902e-6 //0.0035 //0.0025
                                ServoWindowLengthSec = 0.000025; // [BurhanEVM-26Aug]
                                IntialServoMeasTime = 0.00001; // [BurhanEVM-26Aug]
                                FinalServoMeasTime = 0.000025; // [BurhanEVM-26Aug]
                                EVM_Type = "FASTEVM";

                                break;

                            case "SC30B40M106R0S3X10SLOT1CFR9P5EVM":
                                ...
                                Ifile = "I_NCTU2_SC30B40M106R0S3X_10_SLOT1_CFR9.5.txt";
                                Qfile = "Q_NCTU2_SC30B40M106R0S3X_10_SLOT1_CFR9.5.txt";
                                Markers = new List<double> { 0 };

                                SubsetStartSeconds = 0.5e-3;// 4325.2197e-6;
                                SubsetLengthSeconds = 0.5000455e-3;// 589.9902e-6; //0.0045 //0.0025
                                VsgIQrate = 184.32e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.24e-3; //0.0025
                                IntialServoMeasTime = 0.1e-3; //0.01e-3
                                FinalServoMeasTime = 0.24e-3; // 589.9902e-6 //0.0035 //0.0025
                                EVM_Type = "NR";

                                break;

                            case "SC30B40M106R0S3X10SLOT1CFR9P5FASTEVM":
                                ...
                                //SubsetLengthSeconds = 0.5000455e-3;// 589.9902e-6; //0.0045 //0.0025
                                //SubsetStartSeconds = 0.71e-3; // 0.51e-3; // [BurhanEVM-26Aug]
                                //SubsetLengthSeconds = 0.0000125; // [BurhanEVM-26Aug]
                                SubsetStartSeconds = 0.812224e-3; // [BurhanEVM-10Sept]
                                SubsetLengthSeconds = 0.012494e-3; // [BurhanEVM-10Sept]
                                VsgIQrate = 184.32e6m;
                                IsBursted = true;
                                //ServoWindowLengthSec = 0.24e-3; //0.0025
                                //IntialServoMeasTime = 0.1e-3; //0.01e-3
                                //FinalServoMeasTime = 0.24e-3; // 589.9902e-6 //0.0035 //0.0025
                                ServoWindowLengthSec = 0.0000125; // [BurhanEVM-26Aug]
                                IntialServoMeasTime = 0.00001; // [BurhanEVM-26Aug]
                                FinalServoMeasTime = 0.0000125; // [BurhanEVM-26Aug]
                                EVM_Type = "FASTEVM";
                            ...
                            case "SC30B100M273R0S3X50CFRPAPR95DB3XEVM":
                                ...
                                IntialServoMeasTime = 0.001; //0.01e-3		
                                FinalServoMeasTime = 0.0025;//0.0012 // 589.9902e-6 //0.0035 //0.0025 //org 0.0012	
                                EVM_Type = "NR";

                                break;

                            case "SC30B100M273R0S3X50CFRPAPR95DB3XFASTEVM":
                                ...
                                //SubsetStartSeconds = 0.001;
                                //SubsetLengthSeconds = 0.0025;
                                //SubsetStartSeconds = 0.0011; // [BurhanEVM-26Aug]
                                //SubsetLengthSeconds = 0.00000625; // [BurhanEVM-26Aug]
                                SubsetStartSeconds = 6.506177e-3; // [BurhanEVM-10Sept]
                                SubsetLengthSeconds = 0.006248e-3; // [BurhanEVM-10Sept]
                                VsgIQrate = 368.64e6m;
                                IsBursted = true;
                                //ServoWindowLengthSec = 0.234998e-3; //0.0025
                                //IntialServoMeasTime = 0.1e-3; //0.01e-3
                                //FinalServoMeasTime = 0.234998e-3; // 589.9902e-6 //0.0035 //0.0025
                                ServoWindowLengthSec = 0.00000625; // [BurhanEVM-26Aug]
                                IntialServoMeasTime = 0.000001; // [BurhanEVM-26Aug]
                                FinalServoMeasTime = 0.00000625; // [BurhanEVM-26Aug]
                                EVM_Type = "FASTEVM";

                                break;

                            case "SC30B100M273R0S3X50CFRPAPR95DB3XEVMFULL":
                                ...
                                Qfile = "Q_NCTU2_SC30B100M273R0S3X_50_CFRPAPR-9.5dB_3x.txt";
                                Markers = new List<double> { 0 };
                                Markers1 = new List<double> {0.00255,0.00495,0.00755,0.00895};

                                SubsetStartSeconds = 0.001;
                                SubsetLengthSeconds = 0.009;
                                VsgIQrate = 368.64e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.009; //0.0025
                                IntialServoMeasTime = 0.001; //0.01e-3
                                FinalServoMeasTime = 0.009; // 589.9902e-6 //0.0035 //0.0025
                                EVM_Type = "NR";
                            ...
                            case "SC30B20M51R0S3X_10_SLOT1_CFR9P5EVM":
                                RefChBW = 19.095e6;
                                AdjChans.Add("ACLR1", 12.5e6, 3.84e6);
                                AdjChans.Add("ACLR2", 17.5e6, 3.84e6);
                                AdjChans.Add("E-ACLR", 20e6, 19.095e6);
                                ...
                                SubsetStartSeconds = 0.49955512e-3;// 8526.464844e-6;
                                SubsetLengthSeconds = 0.0005000455;// 0.569954427e-3;

                                VsgIQrate = 92.16e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.0005000455;
                                IntialServoMeasTime = 0.1e-3;
                                FinalServoMeasTime = 0.0005000455;// 0.569954427e-3;
                                EVM_Type = "NR";
                                break;                           

                            case "SC30B40M106R0S3X_10_SLOT1_CFR9P5EVM":
                                RefChBW = 38.895e6;
                                AdjChans.Add("ACLR1", 22.5e6, 3.84e6);
                                AdjChans.Add("ACLR2", 27.5e6, 3.84e6);
                                AdjChans.Add("E-ACLR", 40e6, 38.895e6);
                                ...
                                SubsetStartSeconds = 0.49955512e-3;// 8129.703776e-6;
                                SubsetLengthSeconds = 0.0005000455;// 0.329980469e-3;

                                VsgIQrate = 184.32e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.0005000455;
                                IntialServoMeasTime = 0.1e-3;
                                FinalServoMeasTime = 0.0005000455;// 0.329980469e-3;
                                EVM_Type = "NR";
                                break;
                    ...
                    case "NCTU1":
                        ...
                        switch (WvfrmName)
                        {
                            case "SC30B100M273R0S3X50CFRPAPR7DBEVM":
                                RefChBW = 98.31e6;
                                AdjChans.Add("ACLR1", 52.5e6, 3.84e6);
                                AdjChans.Add("ACLR2", 57.5e6, 3.84e6);
                                AdjChans.Add("E-ACLR", 100e6, 98.31e6);

                                Ifile = "I_NCTU1_SC30B100M273R0S3X_V7_CFR7.txt";
                                Qfile = "Q_NCTU1_SC30B100M273R0S3X_V7_CFR7.txt";
                                Markers = new List<double> { 0 };

                                SubsetStartSeconds = 1e-3;
                                SubsetLengthSeconds = 0.002; // 0.5e-3;

                                VsgIQrate = 368.64e6m; //61.44e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 0.0025; // 0.224997e-3;
                                IntialServoMeasTime = 0.001;  //8.272473e-3;// 0.001; //0.01e-3
                                FinalServoMeasTime = 0.0025; //0.224997e-3;
                                EVM_Type = "NR";
                    ...
                    case "NDTUQ":
                        ...
                        switch (WvfrmName)
                        {
                            ...
                            case "SC30B100M135R67S3XV5CFR3P2": //CCDF
                                ...
                                SubsetStartSeconds = 2.39e-3;// 2.603126e-3; 2e-3; 0.9e-3; 
                                SubsetLengthSeconds = 1.499e-4;// 0.144996e-3;
                                VsgIQrate = 368.64e6m;
                                IsBursted = true;
                                ServoWindowLengthSec = 1.499e-4; //0.144996e-3;  //hosein 10192020
                                IntialServoMeasTime = 0.0015;//0.001;
                                FinalServoMeasTime = 1.499e-4; // 0.144996e-3;
                                EVM_Type = "NR";
                            ...
                            case "SC30B100M135R67S3XV7CFR4P5": //CCDF
                    ...
                    case "NDTU2":
                        ...
                        switch (WvfrmName)
                        {
                            ...
                            case "SC30B100M270R0S3X50CFRPAPR71DB3XFASTEVM":
                                ...
                                //SubsetStartSeconds = 0.0011;  // [BurhanEVM-26Aug]
                                //SubsetLengthSeconds = 0.00000625;  // [BurhanEVM-26Aug]
                                SubsetStartSeconds = 7.290523e-3; // [BurhanEVM-10Sept]
                                SubsetLengthSeconds = 0.006248e-3; // [BurhanEVM-10Sept]
                                VsgIQrate = 368.64e6m;
                                IsBursted = true;
                                //ServoWindowLengthSec = 0.00002;                                                                
                                //IntialServoMeasTime = 0.000005; // 0.001;  //0.01e-3
                                //FinalServoMeasTime = 0.00002; // 0.284998e-3; // 589.9902e-6
                                ServoWindowLengthSec = 0.00000625; // [BurhanEVM-26Aug]
                                IntialServoMeasTime = 0.000001; // [BurhanEVM-26Aug]
                                FinalServoMeasTime = 0.00000625; // [BurhanEVM-26Aug]
                                EVM_Type = "FASTEVM";
                    ...
                    case "NDTU6":
                        ...
                        switch (WvfrmName)
                        {
                            case "SC30B100M270R0S3X50CFRPAPR7DBEVM":
                                RefChBW = 98.31e6;
                                AdjChans.Add("ACLR1", 52.5e6, 3.84e6);
                                AdjChans.Add("ACLR2", 57.5e6, 3.84e6);
                                AdjChans.Add("E-ACLR", 100e6, 98.31e6);

                                Ifile = "I_NDTU6_SC30B100M270R0S3X_V7_CFR7.txt";
                                Qfile = "Q_NDTU6_SC30B100M270R0S3X_V7_CFR7.txt";
                                Markers = new List<double> { 0 };
        ...
        public class Waveform
        {
            ...
            public Waveform(string ModStd, string WvfrmName, string Ifile, string Qfile, string BasePath, List<double> Markers, List<double> Markers1, double SubsetStartSeconds, double SubsetLengthSeconds, decimal IQsampleRate, bool IsBursted, double BurstLengthSec, double IntialServoMeasTime, double FinalServoMeasTime,
                double RefChBW, ACLRsettings AdjChans, double AcqRate, double AcqDur, double WvfrmStartTime, double WvfrmTimetoLoad, double Rbw, string EVM_Type)
            {
                ...
                string markersStr1 = "";
                foreach (double marker in Markers1)
                {
                    markersStr1 += (int)(marker * (double)VsgIQrate / 4) * 4 + ",";
                }
                markersStr1 = markersStr1.TrimEnd(',');
